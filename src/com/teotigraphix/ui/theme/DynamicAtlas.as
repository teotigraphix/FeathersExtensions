...
public class DynamicAtlas
{
    ...
    static public function fromClassVector(assets:Vector.<Class>, 
                                           ...
                                           checkBounds:Boolean=false):Object
    {
    ...
    static public function fromInstanceVector(assets:Vector.<DisplayObject>, 
                                              scaleFactor:Number=1, 
                                              margin:uint=0, 
                                              preserveColor:Boolean=true, 
                                              checkBounds:Boolean=false):Object
    {
        var container:MovieClip=new MovieClip();
        for each (var assetInstance:DisplayObject in assets)
        {
            if (assetInstance.name == null)
                assetInstance.name = getQualifiedClassName(assetInstance);
            container.addChild(assetInstance);
        }
        return fromMovieClipContainer(container, scaleFactor, margin, preserveColor, checkBounds);
    }
                                                  ...
                                                  checkBounds:Boolean=false):Object
    {
        ...
        return {atlas:atlas, bitmapData:canvasData};
    }
