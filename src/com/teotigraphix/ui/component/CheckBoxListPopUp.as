...
public class CheckBoxListPopUp extends Panel
{
    ...
    override protected function initialize():void
    {
        ...
        headerFactory = function ():Header
        {
            ...
            _selectAllButton.width = AssetMap.getSize(100);

            _selectNoneButton = new Button();
            _selectNoneButton.label = "None";
            _selectNoneButton.width = AssetMap.getSize(100);
        ...
        footerFactory = function ():LayoutGroup
        {
            ...
            fl.padding = AssetMap.getSize(10);
            footer.layout = fl;

            _okButton = new Button();
            _okButton.label = "OK";
            _okButton.width = AssetMap.getSize(200);

            _cancelButton = new Button();
            _cancelButton.label = "Cancel";
            _cancelButton.width = AssetMap.getSize(200);
