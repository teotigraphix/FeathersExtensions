...
////////////////////////////////////////////////////////////////////////////////
package com.teotigraphix.controller.command.file
{
...
public class __BrowseWithFileDialogStep extends StepCommand
{
    ...
    private var _isBackButtonEnabled:Boolean;    
    ...
    public function get isBackButtonEnabled():Boolean
    {
        return _isBackButtonEnabled;
    }
    
    public function set isBackButtonEnabled(value:Boolean):void
    {
    ...
    override public function execute():*
    {
        ...
        {
            eventDispatcher.addEventListener(ApplicationEventType.BACK_CHANGE, context_backChangeHandler);
            eventDispatcher.addEventListener(ApplicationEventType.BACK_CHANGED, context_backChangedHandler);
        }
    ...
    protected function context_backChangeHandler(event:Event):void
    {
        ApplicationEventData(event.data).isBackHandled = true;
    }
    
    protected function context_backChangedHandler(event:Event):void
    {
        hide();
        cancel();
    }
    ...
    protected function hide():void
    {
        if (_isBackButtonEnabled)
        {
            eventDispatcher.removeEventListener(ApplicationEventType.BACK_CHANGE, context_backChangeHandler);
            eventDispatcher.removeEventListener(ApplicationEventType.BACK_CHANGED, context_backChangedHandler);
        }
